# Internationaler Markenname: Sammlung

_Gesammelt: 2026-07-26_

---

## Produktstrategie International (umgekehrt zu DE)

| Priorität | Produkt | Preis |
|---|---|---|
| 1 (Einstieg) | Hochzeitshomepage | 500 € |
| 2 (Premium) | Trauredner / Officiant | ab 1.500 € |

Logik: Die Homepage ist der skalierbare Funnel-Einstieg.  
Der Trauredner ist das hochpreisige Upsell für Paare, die Eduard persönlich wollen – auch international (Destination Wedding in der Lüneburger Heide, Elopement, etc.)

---

## Namensideen

### Richtung 1: Homepage zuerst, Vows/Ceremony dahinter
_Das Produkt kommuniziert direkt, der Name macht neugierig._

| Name | Domäne | Gedanke |
|---|---|---|
| **vowpage.com** | prüfen | Kurz, direkt: vow (Gelübde) + page (Website) |
| **yourvowpage.com** | prüfen | Persönlicher Ansprache |
| **vowsite.com** | prüfen | Noch direkter |
| **vowcraft.com** | prüfen | Craft = handgemacht, Premium-Gefühl |
| **vowstudio.com** | prüfen | Studio = professionell, deckt beide Produkte ab |
| **weddingcanvas.com** | prüfen | Canvas = leere Leinwand, individuell |
| **yourweddingpage.com** | prüfen | Sehr klar, kein Interpretationsspielraum |

### Richtung 2: Ceremony/Emotion im Fokus
_Deckt Homepage + Trauredner gleichzeitig ab._

| Name | Domäne | Gedanke |
|---|---|---|
| **ceremonystudio.com** | prüfen | Sauber, professionell, beides abgedeckt |
| **hearthvows.com** | prüfen | Hearth = Herz/Herd (Wärme), Vows = Gelübde |
| **vowsandpages.com** | prüfen | Explizit beides genannt |
| **tiedwith.love** | prüfen | .love TLD, emotional, Pinterest-tauglich |
| **yourdaymade.com** | prüfen | Ergebnis-fokussiert |

### Richtung 3: Storytelling / Heide-Referenz international
_Eduard hat eine starke persönliche Marke – kann auch international tragen._

| Name | Domäne | Gedanke |
|---|---|---|
| **heathervows.com** | prüfen | Heather = Heide auf Englisch, sehr stimmig |
| **heatherandvows.com** | prüfen | Spielerischer |
| **theheidestudio.com** | prüfen | Beibehaltung „Heide" als Eigenname |
| **heideweddings.com** | prüfen | Direkt, ortsgebunden (Lüneburger Heide) |
...
- [ ] .com verfügbar (wichtigste Endung für internationale Märkte)
- [ ] Leicht auszusprechen auf Englisch
- [ ] Funktioniert als Pinterest-Handle (@vowstudio o.ä.)
- [ ] Keine Trademark-Konflikte (kurze Google-Prüfung)
- [ ] Erklärt sich selbst oder macht neugierig
...
2. Pinterest-Handle-Verfügbarkeit prüfen
3. Entscheidung → Domain sichern
4. Englische Landingpage unter neuer Domain aufbauen
